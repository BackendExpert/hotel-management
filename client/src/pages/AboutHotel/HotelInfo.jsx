    ...
    <div className="py-24" >
        ...
        <div className="md:mx-24 mx-4 mt-16" >
            <div className="xl:flex">
                <div data-aos="zoom-in" className="py-60 w-full block relative bg-[url(https://wallpapercave.com/wp/wp12672119.jpg)] bg-cover bg-center">
                ...
                <div className="w-full bg-white flex flex-col items-center justify-center text-center p-8" data-aos="zoom-in">
